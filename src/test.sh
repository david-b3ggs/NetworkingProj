...
java -cp Client.jar tiktak.app.client.Client wind 12389 beggs TOST

java -cp Client.jar tiktak.app.client.Client wind 12390 beggs xvkby LTSRL coolpics imagedata otherdata

java -cp Client.jar tiktak.app.client.Client wind 12391 beggs TOS

java -cp Client.jar tiktak.app.client.Client wind.ecs.baylor.edu 12392 beggs xvkby LTSR coolpics imagedata
